...
Two types of survey simulation software frameworks were used to generate and validate LSST SSO discovery statistics, namely
\begin{itemize}
...
By the nominal end of the LSST survey we know essentially all MBAs with diameters of half a kilometer and larger.
...
\clearpage
%%%%%%%%%%%%%%%%%%%
\section{Impact of delayed LSST operations and Solar System Processing} \label{sec:delay}
\begin{figure}[tb!]
\begin{center}
...
\section{Solar System Objects as a Source of Noise} \label{sec:noise}
\begin{figure}[tb!]
\begin{center}
\begin{tabular}{cc}
...
An object must have at least two observations per night over three nights in a 15-30 night window to be considered a candidate object that can be sent to and validated by the MPC.
...
One can see that the LSST MBA survey is bound to discover practically all objects down to absolute magnitude $H=19.5$mag. The 50\% completeness mark is $H=21.5$mag.
...
\section{Expected MPC Data Rates}\label{sec:data}
...
%\begin{figure}
%\begin{center}
%\includegraphics[width=0.90\linewidth]{figs/attributed3.png}
%\end{center}
%\caption{Expected number of nightly LSST observations for MBA population models with $\alpha=0.3$ and $\alpha=0.56$, as well as for known objects}
%\label{fig:attrib3}       % Give a unique label
%\end{figure}

%\begin{figure}
%\begin{tabular}{cc}
%\includegraphics[scale=1]{figs/mba_completenss3.png} &
%\includegraphics[scale=1]{figs/mba_completeness.png}
%\end{tabular}
%\caption{Survey completeness for MBAs at a given H as a function of time.}
%
%\label{fig:compl}       % Give a unique label
%\end{figure}
...
%\begin{figure}
%\begin{center}
%\includegraphics[scale=.3]{figs/obs_vs_time3.png}
%\end{center}
%\caption{Expected number of nightly LSST observations for MBA population models with $\alpha=0.3$ and $\alpha=0.56$, as well as for known objects}
%\label{fig:mba_pop}       % Give a unique label
%\end{figure}
...
%\begin{figure}
%\begin{tabular}{ll}
%\includegraphics[scale=1]{figs/disc_vs_H3.png} &
%\includegraphics[scale=1]{figs/disc_nights2.png}
%\end{tabular}
%\caption{Survey completeness for MBAs at a given H as a function of time.}
%\label{fig:compl}       % Give a unique label
%\end{figure}
...
%\begin{figure}
%\begin{center}
%\includegraphics[scale=.5]{figs/disc_nights2.png}
%\end{center}
%\caption{Expected number of nightly LSST observations for MBA population models with $\alpha=0.3$ and $\alpha=0.56$, as well as for known objects}
%\label{fig:mba_pop}       % Give a unique label
%\end{figure}
